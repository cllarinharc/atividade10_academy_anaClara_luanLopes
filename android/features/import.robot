...
*** Test Cases ***
TC-Deve ser possíevl acessar o Importar Dados
...
TC- Deve ser possível Importar dados do Restaurar produtos
    Dado que o cliente está na página inicial
    Quando clica em Menu
    E clica em Importar Dados
...
TC- Deve ser possível Importar dados do Restaurar Entradas
    Dado que o cliente está na página inicial
    Quando clica em Menu
    E clica em Importar Dados
...
TC- Deve ser possível Importar dados do Restaurar Saidas
    Dado que o cliente está na página inicial
    Quando clica em Menu
    E clica em Importar Dados
...
TC- Deve ser possível Importar dados do Grupo de produtos
    Dado que o cliente está na página inicial
    Quando clica em Menu
    E clica em Importar Dados
